...
public class Song {
  ...
  public boolean equals(Object obj) {
    ...
    return this.title != null && this.title.equalsIgnoreCase(song.title)
      && this.artist != null && this.artist.equalsIgnoreCase(song.artist);
  }
  ...
  public static class Builder {
    ...
    public Builder setTitle(String title) {
      if ("".trim().equals(title)) title = null;
      this.title = title;
      return this;
    }

    public Builder setArtist(String artist) {
      if ("".trim().equals(title)) artist = null;
      this.artist = artist;
      return this;
    }

    public Builder setAlbum(String album) {
      if ("".trim().equals(title)) album = null;
      this.album = album;
      return this;
    }
